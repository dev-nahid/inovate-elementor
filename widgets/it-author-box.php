...
class Author_Box_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Author Box', 'inovate-elementor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'it_author_name',
			[
				'label' => __( 'Author Name', 'inovate-elementor' ),
                'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Author Name', 'inovate-elementor' ),
                'dynamic' => [
					'active' => true,
				],
                'label_block' => true,
				'placeholder' => __( 'Write Author Name', 'inovate-elementor' ),
			],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Author Designation', 'inovate-elementor' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => esc_html__( 'Author', 'inovate-elementor' ),
				'dynamic' => [
					'active' => true,
				],
				'placeholder' => __( 'Write Author Designation', 'inovate-elementor' ),
			]
        );
		...
		$this->add_control(
			'it_author_img',
			[
				'label' => esc_html__( 'Author Image', 'inovate-elementor' ),
		...
		$this->start_controls_section(
			'social_section',
			[
				'label' => __( 'Social Link', 'inovate-elementor' ),
			]
		);
		// Facebook Link
		$this->add_control(
			'facebook_link',
			[
				'label' => esc_html__( 'Facebook Link', 'inovate-elementor' ),
		...
		$this->add_control(
			'instagram_link',
			[
				'label' => esc_html__( 'Instagram Link', 'inovate-elementor' ),
				'type' => \Elementor\Controls_Manager::URL,
				'dynamic' => [
					'active' => true,
				],
		...
		$this->add_control(
			'linkedin_link',
			[
				'label' => esc_html__( 'Linkedin Link', 'inovate-elementor' ),
				'type' => \Elementor\Controls_Manager::URL,
				'dynamic' => [
					'active' => true,
				],
